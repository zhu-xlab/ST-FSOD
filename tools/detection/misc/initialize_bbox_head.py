...
def parse_args():
    ...
    parser.add_argument('--isaid', action='store_true', help='For ISAID models')
    parser.add_argument('--nwpu', action='store_true', help='For NWPU models')
...
def main():
    ...
    if args.coco:
        ...
        TAR_SIZE = DIOR_TAR_SIZE
    elif args.isaid:
        TAR_SIZE = ISAID_TAR_SIZE
    elif args.nwpu:
        TAR_SIZE = NWPU_TAR_SIZE
    else:
