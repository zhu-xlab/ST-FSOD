...
from rsidet.models.builder import HEADS, build_loss
from rsidet.models.dense_heads import AnchorFreeHead
...
class SAMHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is SAMHead):
        ...
        self.act_cfg = act_cfg if act_cfg is not None else dict(type='ReLU', inplace=True)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is SAMHead:
            convert_dict = {
    ...
    def forward_single(self, x, img_metas):
        ...
        return all_cls_scores.unsqueeze(0), all_bbox_preds.unsqueeze(0)
    ...
    def loss_single(self,
        ...
        # # label_weights[pos_inds] = labels.shape[0] / (2 * num_pos)
        # # label_weights[neg_inds] = labels.shape[0] / (2 * num_neg)
        # label_weights[pos_inds] = 1
        # label_weights[neg_inds] = num_pos / num_neg
    ...
    def _get_target_single(self,
        ...
        assign_result = self.assigner.assign(
            det_bboxes, gt_bboxes, gt_bboxes_ignore,
            gt_labels
        )
    ...
    def onnx_export(self, all_cls_scores_list, all_bbox_preds_list, img_metas):
        ...
        from rsidet.core.export import dynamic_clip_for_onnx
