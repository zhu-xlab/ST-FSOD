...
class UFDRPNHead(AnchorHead):
    ...
    def __init__(self,
        ...
        # 3 channels (seen fg, unseen fg, background) for the classifier
        super(UFDRPNHead, self).__init__(
            3, in_channels, init_cfg=init_cfg, **kwargs)
    ...
    def forward_train(self,
        ...
        if proposal_cfg is None:
            ...
            proposal_list_neg = self.get_bboxes(
                *outs, img_metas=img_metas, cfg=proposal_cfg, apply_neg=True)
    ...
    def loss(self,
        ...
        """
        losses = super(UFDRPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def _get_bboxes_single(self,
        ...
        return self._bbox_post_process(mlvl_scores, mlvl_bbox_preds,
                                       ...
                                       img_shape, apply_neg=apply_neg)

    def _bbox_post_process(self, mlvl_scores, mlvl_bboxes, mlvl_valid_anchors,
                           level_ids, cfg, img_shape, apply_neg=False, **kwargs):
