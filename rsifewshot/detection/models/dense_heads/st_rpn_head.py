...
class STRPNHead(AnchorHead):
    ...
    def forward_single(self, x):
        ...
        if self.use_stu:
            rpn_cls_score_stu = self.rpn_cls_stu(x)
            rpn_bbox_pred_stu = self.rpn_reg_stu(x)
    ...
    def forward_train(self,
        ...
        if self.use_stu:
            ...
            outs = self(x)
            rpn_cls_score_stu=None
            rpn_bbox_pred_stu=None
        ...
        losses = self.loss(*loss_inputs, gt_bboxes_ignore=gt_bboxes_ignore,
                           cls_scores_stu=rpn_cls_score_stu, bbox_preds_stu=rpn_bbox_pred_stu)
        if proposal_cfg is None:
            ...
            proposal_list_neg = self.get_bboxes(
                *outs, img_metas=img_metas, cfg=proposal_cfg, nms_type='reverse')
