...
class STRPNHeadV3(AnchorHead):
    ...
    def __init__(self,
        ...
        super(STRPNHeadV3, self).__init__(
    ...
    def forward_single_test(self, ori_x):
        """Forward feature map of a single scale level."""
        ...
        return rpn_cls_score, rpn_bbox_pred, rpn_cls_score_stu, \
                rpn_bbox_pred_stu
        # return rpn_cls_score, rpn_bbox_pred, rpn_cls_score, \
        #         rpn_bbox_pred
    ...
    def simple_test_rpn(self, x, img_metas, proposal_cfg=None):
        ...
        """
        base_cls_score, base_bbox_pred, novel_cls_score, novel_bbox_pred = multi_apply(self.forward_single_test, x)
        # base_cls_score, base_bbox_pred, novel_cls_score, novel_bbox_pred = self(x)
        # all_cls_score = []
        # all_bbox_pred = []
