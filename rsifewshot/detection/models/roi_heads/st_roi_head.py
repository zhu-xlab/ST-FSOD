...
class STRoIHead(StandardRoIHead):
    ...
    def __init__(self, stu_bbox_head=None, alpha=0.999,
        ...
        super(STRoIHead, self).__init__(**kwargs)
    ...
    def forward_train(self,
        ...
        if self.with_bbox or self.with_mask:
            ...
            for i in range(num_imgs):
                ...
                if proposal_list_neg is not None:
                    ...
                    sampling_result_neg = None
                    sampling_result = sampling_result_pos
        ...
        ) if proposal_list_neg is not None else {}
