...
DIOR_SPLIT = dict(
    ALL_CLASSES_SPLIT0 = ('airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge',
                         ...
                         'windmill'),
    ALL_CLASSES_SPLIT1 = (
        'airport', 'basketballcourt', 'bridge', 'chimney', 'dam',
    ...
    ALL_CLASSES_SPLIT2 = (
        'airplane', 'airport', 'dam', 'Expressway-Service-area',
        'Expressway-toll-station', 'golffield', 'groundtrackfield',
        'harbor', 'overpass', 'stadium', 'storagetank',
    ...
    ALL_CLASSES_SPLIT3 = (
        'baseballfield', 'basketballcourt', 'bridge', 'chimney',
        'dam', 'Expressway-Service-area', 'golffield',
    ...
    NOVEL_CLASSES_SPLIT4=(
        'dam', 'golffield', 'storagetank', 'tenniscourt', 'vehicle',
    ),

    ALL_CLASSES_SPLIT5 = (
        'airplane', 'airport', 'baseballfield', 'basketballcourt', 'bridge',
        'chimney', 'dam', 'Expressway-toll-station',
        'golffield', 'groundtrackfield', 'harbor', 'ship',
...
class FewShotDIORCaptionDataset(BaseFewShotDataset):
...
@DATASETS.register_module()
class FewShotDIORCaptionCopyDataset(FewShotDIORCaptionDataset):
...
@DATASETS.register_module()
class FewShotDIORCaptionDefaultDataset(FewShotDIORCaptionDataset):
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        return super(FewShotDIORCaptionDataset, self).ann_cfg_parser(new_ann_cfg)
