...
rsidet_minimum_version = '2.16.0'
rsidet_maximum_version = '2.26.0'
rsidet_version = digit_version(rsidet.__version__)


assert (digit_version(rsidet_minimum_version) <= rsidet_version
        <= digit_version(rsidet_maximum_version)), \
    f'MMDET=={rsidet.__version__} is used but incompatible. ' \
    f'Please install rsidet>={rsidet_minimum_version},\
     <={rsidet_maximum_version}.'
