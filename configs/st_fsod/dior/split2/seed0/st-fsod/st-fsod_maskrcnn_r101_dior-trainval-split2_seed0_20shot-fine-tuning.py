...
expr_name = 'st-fsod_maskrcnn_r101_40k_dior-trainval-split2_seed0_20shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=300,
             # bbox_score_thr=0.0,
             bbox_score_thr=[0.9810983, 0.9728869, 0.9542238, 0.9881815, 0.87075484, 0.9837986,
                             0.9119891, 0.9930742, 0.94611293, 0.9463126, 0.97607124, 0.9908197,
                             0.9702221, 0.99254364, 0.9343005, 0.8944829, 0.9921169, 0.8988681,
                             0.9827646, 0.05001878],
