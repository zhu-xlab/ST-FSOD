...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/dior-split1_20shot_seed{seed}.json',
...
load_from = ('work_dirs/st-fsod_maskrcnn_r101_40k_dior-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-fsod_maskrcnn_r101_dior-split1_seed0_20shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=300,
             bbox_score_thr=[0.97266084, 0.9887507, 0.97420514, 0.973706, 0.9226412,
                             0.9892496, 0.9614947, 0.9875721, 0.97279084, 0.96904993, 0.9832075,
                             0.97809786, 0.9266546, 0.98300636, 0.99685746, 0.9719037, 0.96816725,
                             0.80844116, 0.9964647, 0.8169935],
             eval_after_run=False,
            wandb_boxes_resize_factor = 0.657894736)
    ])
