...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/dior-split5_3shot_seed{seed}.json',
...
expr_name = 'st-fsod_maskrcnn_r101_40k_dior-trainval-split5_seed0_3shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
