...
data = dict(
    train=dict(
        ...
        # ann_cfg=[dict(method='TFA', setting='SPLIT4_3SHOT')],
        num_novel_shots=10,
        num_base_shots=None,
        classes='ALL_CLASSES_SPLIT4',
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/dior-split4_10shot_seed{seed}.json',
...
load_from = ('work_dirs/st-fsod_maskrcnn_r101_40k_dior-trainval-split4_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-fsod_maskrcnn_r101_40k_dior-trainval-split4_seed0_10shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
