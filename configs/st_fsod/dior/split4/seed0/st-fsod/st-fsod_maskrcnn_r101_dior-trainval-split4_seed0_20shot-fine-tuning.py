...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/dior-split4_20shot_seed{seed}.json',
...
expr_name = 'st-fsod_maskrcnn_r101_40k_dior-trainval-split4_seed0_20shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
