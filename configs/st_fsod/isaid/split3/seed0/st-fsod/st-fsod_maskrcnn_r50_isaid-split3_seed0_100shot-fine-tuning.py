...
data = dict(
    train=dict(
        ...
        save_dataset=True,
        save_dataset_path=f'work_dirs/data_infos/isaid-split3_100shot_seed{seed}.json',
...
load_from = ('work_dirs/st-fsod_maskrcnn_r50_80k_isaid-split3_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-fsod_maskrcnn_r50_isaid-split3_seed0_100shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=400,
             bbox_score_thr=[0.972, 0.972, 0.981, 0.960, 0.981, 0.975, 0.976, 0.995, 0.981, 0.850,
                             0.986, 0.960, 0.854, 0.906, 0.997],
             eval_after_run=True)
    ])
