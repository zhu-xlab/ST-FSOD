...
load_from = ('work_dirs/st-fsod_maskrcnn_r50_80k_isaid-split1_randomized_head/base_model_random_init_bbox_head.pth')

expr_name = 'st-fsod_maskrcnn_r50_isaid-split1_seed0_100shot_fine-tuning'
init_kwargs = {
    'project': 'rsi-fewshot',
    'entity': 'tum-tanmlh',
    'name': expr_name,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='RSIDetWandbHook',
             ...
             num_eval_images=400,
             bbox_score_thr=[0.982, 0.930, 0.983, 0.991, 0.990, 0.947, 0.947, 0.941, 0.968, 0.666,
                             0.930, 0.947, 0.053, 0.801, 0.052],
